...
{
    private JComboBox component_name;
    private JTextField property_name;
    private JTextField property_values;
    ...
    public CPFrame(){
        ...
        component_name = new JComboBox();
       // system_name.setSize(new Dimension(30,80));
        component_name = new JComboBox();
        property_name = new JTextField(10);
        ...
        psn.add(component_name);
        panel_left.add(psn);
       
        panel_left.add(new JLabel("property name"));
        JPanel pcn = new JPanel();
        pcn.add(property_name);
        panel_left.add(pcn);
        
        panel_left.add(new JLabel("property values"));
        JPanel pcs = new JPanel();
        pcs.add(property_values);
        panel_left.add(pcs);
